...
Route::get('/treatment-assets', [TreatmentController::class, 'assetIndex']);
Route::post('/treatment-assets', [TreatmentController::class, 'storeAsset']);
Route::put('/treatment-assets/{id}', [TreatmentController::class, 'updateAsset']);
Route::put('/treatment-assets/{id}/steps', [TreatmentController::class, 'updateAssetSteps']);
Route::delete('/treatment-assets/{id}', [TreatmentController::class, 'destroyAsset']);
...
Route::post('/bookings/{id}/payment/sandbox-success', [BookingController::class, 'sandboxPaymentSuccess']);
